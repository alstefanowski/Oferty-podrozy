...
{
    [Authorize]
    public class AnulowanieModel : PageModel
    {

        private readonly Projekt.Data.ApplicationDbContext _context;

        public AnulowanieModel(Projekt.Data.ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            var tripmodel = await _context.TripModel.FirstOrDefaultAsync(a => a.Id == userstrip.Trip);

            if (userstrip == null || tripmodel==null)
            {
                return NotFound();
            }
            else
        ...
        {
            if (id == null || _context.UsersTrip == null|| _context.TripModel == null)
            {
                return NotFound();
            }
